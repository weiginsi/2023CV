...
#读取各种信息方法
    def ReadInfo(self):
        ...
        path = "D:/1_user/videos/5_8/test4.mp4"
        # 保存所读取动作的名称
...
def main():
    ...
    Test=MainTest()
    # 创建主窗口并显示
    window = gui.MainWindow(OpenVideo,train,Test)
    window.show()
    sys.exit(app.exec_())
    # 保存获取的动作数据的地址
    ...
    #         #cap = OpenVideo.OpenVideo("D:/1_user/videos/test6.mp4")
    #         # video_path = "D:/1_user/videos/5_8/test6.mp4"
    #         #
    #         #引用ModelTest中的ActionRecognition方法判断动作
    #         OpenVideo.ActionRecognition(window.cap,window)
    #         sys.exit(app.exec_())
    #
    #         #
    #         # # 列出系统上的所有物理设备
    ...
    #         # if gpu_devices:
    #         #     print('TensorFlow 正在使用 GPU 进行计算')
    #         # else:
    #         #     print('TensorFlow 正在使用 CPU 进行计算')
    #
    #         continue
